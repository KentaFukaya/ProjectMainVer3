...
/*
 * Created by 1014159 on 2016/07/01.
...
public class ZukanSQLiteOpenFromAssets extends SQLiteOpenHelper {
    private Context mContext;
    private String mDBName;
    private boolean mUpgrade;

    public ZukanSQLiteOpenFromAssets(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
